...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnFloat.setOnClickListener(v -> {
            prefs.edit().putInt("min_price", Integer.parseInt(
                etPrice.getText().toString().isEmpty() ? "0" : etPrice.getText().toString())).apply();
            prefs.edit().putInt("max_dist", Integer.parseInt(
                etDist.getText().toString().isEmpty() ? "99" : etDist.getText().toString())).apply();
